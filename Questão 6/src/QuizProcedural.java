...
public class QuizProcedural {
	...
	public static void main(String[] args) {
		...
		System.out.println("1 - Vaticano e Russia / 2 - Nauru e China / 3 - Monaco e Canada / 4 - Malta e Estados Unidos");
		resposta = sc.next().charAt(0);
		if(resposta == '1') {
			System.out.println("ACERTOU! Proxima..");
			acertadas++;
		...
		System.out.println("1 - O Senhor dos Aneis / 2 - Dom Quixote / 3 - O Pequeno Principe / 4 - Um Conto de Duas Cidades");
		resposta = sc.next().charAt(0);
		if(resposta == '1') {
			System.out.println("Errado! Proxima..");
			erradas++;
